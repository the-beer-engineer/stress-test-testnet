...
var RawTransactions = function () {
  ...
  _createClass(RawTransactions, [{
    ...
    key: 'sendRawTransaction',
      value: function sendRawTransaction(hex, allowhighfees=false, rpcuser = null, rpcpassword = null, rpcport = null, rpchost = "127.0.0.1") {
      ...
      if (typeof hex !== 'string') {
        ...
        if (this.bitcoind !== null) {
          ...
          return new Promise((resolve, reject) => {
            ...
            _bitcoind.call(
              { "jsonrpc": "1.0", "id": "bch" + Math.floor((Math.random() * 1000000) + 1), "method": "sendrawtransaction", "params": [hex] },
              function (err, res) {
          ...
          console.log(this.restURL + 'rawtransactions/sendRawTransaction/' + hex + '?allowhighfees=' + allowhighfees);
